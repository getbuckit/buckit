...
| [**AssumeRole**](https://github.com/minio/minio/blob/master/docs/sts/assume-role.md)   | Let BuckIt users request temporary credentials using user access and secret keys.                                                              |
