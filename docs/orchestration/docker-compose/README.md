...
* There are 4 buckit distributed instances created by default. You can add more BuckIt services (up to total 16) to your BuckIt Compose deployment. To add a service
  ...
  * Add a new BuckIt server instance to the upstream directive in the Nginx configuration file.
  ...
  Read more about distributed BuckIt [here](https://docs.min.io/community/minio-object-store/operations/deployments/baremetal-deploy-minio-as-a-container.html).

### Explore Further

* [Overview of Docker Compose](https://docs.docker.com/compose/overview/)
* [BuckIt Docker Quickstart Guide](https://docs.min.io/community/minio-object-store/operations/deployments/baremetal-deploy-minio-as-a-container.html)
