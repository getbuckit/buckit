...
- BuckIt object storage set up per <https://docs.min.io/community/minio-object-store/index.html>
...
- Configure the buckit client for the Veeam BuckIt endpoint - <https://docs.min.io/community/minio-object-store/operations/deployments/baremetal-deploy-minio-on-redhat-linux.html>
